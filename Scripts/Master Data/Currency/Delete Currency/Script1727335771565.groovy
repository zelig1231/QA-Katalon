...
WebUI.click(findTestObject('Object Repository/Master_Data/Currency/button_Delete'))

WebUI.click(findTestObject('Object Repository/Master_Data/Currency/button_Yes'))
