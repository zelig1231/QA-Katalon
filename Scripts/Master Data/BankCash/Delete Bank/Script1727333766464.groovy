...
WebUI.click(findTestObject('Object Repository/Master_Data/BankCash/button_Delete'))

WebUI.click(findTestObject('Object Repository/Master_Data/BankCash/button_Yes'))
